...
public class AddEventActivity extends AppCompatActivity {
    ...
    public void init() {
        ...
        firebase = new Firebase("https://postboard1.firebaseio.com/");
    ...
    public void setValidator()
    {
        validator1.setValidationListener(new Validator.ValidationListener() {
            ...
            public void onValidationSucceeded() {
                ...
                config.put("cloud_name", "dhjkcf1gt");
                config.put("api_key", "234113219819998");
                config.put("api_secret", "Y1yVxwaW6uNqekEEpI6LEpuarSQ");
